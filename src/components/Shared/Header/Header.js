...
const Header = () => {
    ...
    return (
        <>
            <Navbar collapseOnSelect expand="lg" variant="dark" sticky="top" className="nav-area">
                <Container>
                <Navbar.Brand href="#home">Trip Master</Navbar.Brand>
                    ...
                    <Navbar.Collapse className="justify-content-end nav-list">
                        ...
                        <Navbar.Text className="display-name"><a href="#login">{users?.displayName && users.displayName}</a>
                        </Navbar.Text>
                    </Navbar.Collapse>
